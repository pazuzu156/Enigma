...
*/
    ...
    #pragma warning( pop )
    #define PYTHON_LOADED 1
#endif

#ifdef ENIGMA_PLATFORM_LINUX
    #include <boost/python.hpp>
    #define PYTHON_LOADED 2
#endif

#ifdef ENIGMA_PLATFORM_MAC
    #include <boost/python.hpp>
    #define PYTHON_LOADED 3
#endif

#ifdef ENIGMA_PLATFORM_BSD
    #include <boost/python.hpp>
    #define PYTHON_LOADED 4
#endif

#ifdef ENIGMA_PLATFORM_OPENSOLARIS
    #include <boost/python.hpp>
    #define PYTHON_LOADED 5
#endif

#ifndef PYTHON_LOADED
    #include <boost/python.hpp>
    #define PYTHON_LOADED 6
#endif
