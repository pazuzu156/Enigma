...
*/
    ...
    #include <time.h>
    #pragma warning( pop )
    #define STD_TIME_LOADED 1
#endif

#ifdef ENIGMA_PLATFORM_LINUX
    #include <time.h>
    #define STD_TIME_LOADED 2
#endif

#ifdef ENIGMA_PLATFORM_MAC
    #include <time.h>
    #define STD_TIME_LOADED 3
#endif

#ifdef ENIGMA_PLATFORM_BSD
    #include <time.h>
    #define STD_TIME_LOADED 4
#endif

#ifdef ENIGMA_PLATFORM_OPENSOLARIS
    #include <time.h>
    #define STD_TIME_LOADED 5
#endif

#ifndef STD_TIME_LOADED
    #include <time.h>
    #define STD_TIME_LOADED 6
#endif
