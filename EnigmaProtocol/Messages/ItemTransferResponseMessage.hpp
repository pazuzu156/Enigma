#ifndef ITEMTRANSFERRESPONSEMESSAGE_HPP_INCLUDED
#define ITEMTRANSFERRESPONSEMESSAGE_HPP_INCLUDED
...
namespace Enigma
{
    class DllExport ItemTransferResponseMessage : public MessageContainer
    {
        private:
        ...
        ItemTransferResponseMessage(Message& message)
            :MessageContainer(message){};

        ItemTransferResponseMessage();
        ~ItemTransferResponseMessage();

        static const int GetMessageType(){return 41;}
...
#endif // ITEMTRANSFERRESPONSEMESSAGE_HPP_INCLUDED
