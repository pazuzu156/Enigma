...
namespace Enigma
{
    ...
    ItemOnMapUpdateRequestMessage::ItemOnMapUpdateRequestMessage()
    {
        size_t size;
        size = ItemOnMapUpdateRequestMessage::GetMessageLength();
        this->ResizeMessage(size,0);
        this->SetType(ItemOnMapUpdateRequestMessage::GetMessageType());
