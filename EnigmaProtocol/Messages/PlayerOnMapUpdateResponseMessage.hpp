#ifndef PLAYERONMAPUPDATERESPONSEMESSAGE_HPP_INCLUDED
#define PLAYERONMAPUPDATERESPONSEMESSAGE_HPP_INCLUDED
...
namespace Enigma
{
    class DllExport PlayerOnMapUpdateResponseMessage : public MessageContainer
    {
        private:
        ...
        PlayerOnMapUpdateResponseMessage(Message& message)
            :MessageContainer(message){};

        PlayerOnMapUpdateResponseMessage();
        ~PlayerOnMapUpdateResponseMessage();

        static const int GetMessageType(){return 11;}
...
#endif // PLAYERONMAPUPDATERESPONSEMESSAGE_HPP_INCLUDED
