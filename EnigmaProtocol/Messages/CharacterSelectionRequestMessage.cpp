...
namespace Enigma
{
    ...
    {
        size_t size;
        size = CharacterSelectionRequestMessage::GetMessageLength();
        this->ResizeMessage(size,0);
        this->SetType(CharacterSelectionRequestMessage::GetMessageType());
    ...
    Enigma::s32 CharacterSelectionRequestMessage::GetCharacterIndex()
    {
        return this->GetInt(0);
    }

    void CharacterSelectionRequestMessage::SetCharacterIndex(Enigma::s32 value)
    {
        this->SetInt(0,value);
    }
