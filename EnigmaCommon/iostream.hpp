...
*/
    ...
    #include <iostream>
    #pragma warning( pop )
    #define IOSTREAM_LOADED 1
#endif

#ifdef ENIGMA_PLATFORM_LINUX
    #include <iostream>
    #define IOSTREAM_LOADED 2
#endif

#ifdef ENIGMA_PLATFORM_MAC
    #include <iostream>
    #define IOSTREAM_LOADED 3
#endif

#ifdef ENIGMA_PLATFORM_BSD
    #include <iostream>
    #define IOSTREAM_LOADED 4
#endif

#ifdef ENIGMA_PLATFORM_OPENSOLARIS
    #include <iostream>
    #define IOSTREAM_LOADED 5
#endif

#ifndef IOSTREAM_LOADED
    #include <iostream>
    #define IOSTREAM_LOADED 6
#endif

#endif // IOSTREAM_HPP_INCLUDED
