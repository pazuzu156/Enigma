...
#include "ChatResponseMessage.hpp"
...
namespace Enigma
{
    ...
    {
        size_t size;
        size = ChatResponseMessage::GetMessageLength();
        this->ResizeMessage(size,0);
        this->SetType(ChatResponseMessage::GetMessageType());
        this->mChatMessage="";
        this->mChatTarget="";
    ...
    Enigma::s32 ChatResponseMessage::GetChatType()
    {
        return this->GetInt(0);
    }

    void ChatResponseMessage::SetChatType(Enigma::s32 value)
    {
        this->SetInt(0,value);
        this->mChatType=value;
    }

    const std::string& ChatResponseMessage::GetChatMessage() const
    {
        return this->mChatMessage;
    }

    void ChatResponseMessage::SetChatMessage(const std::string& value)
    {
        this->mChatMessage=value;
    }

    const std::string& ChatResponseMessage::GetChatTarget() const
    {
        return this->mChatTarget;
    }

    void ChatResponseMessage::SetChatTarget(const std::string& value)
    {
        this->mChatTarget=value;
    }

    void ChatResponseMessage::UpdateMessageData()
    {
		std::string temp;
    ...
    void ChatResponseMessage::GetMessageData()
    {
