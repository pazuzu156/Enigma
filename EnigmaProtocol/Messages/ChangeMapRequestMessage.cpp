...
namespace Enigma
{
    ...
    {
        size_t size;
        size = ChangeMapRequestMessage::GetMessageLength();
        this->ResizeMessage(size,0);
        this->SetType(ChangeMapRequestMessage::GetMessageType());
    ...
    Enigma::s32 ChangeMapRequestMessage::GetTargetMap()
    {
        return this->GetInt(0);
    }

    void ChangeMapRequestMessage::SetTargetMap(Enigma::s32 value)
    {
        this->SetInt(0,value);
    }
