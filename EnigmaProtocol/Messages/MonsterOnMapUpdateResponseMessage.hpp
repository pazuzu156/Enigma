#ifndef MONSTERONMAPUPDATERESPONSEMESSAGE_HPP_INCLUDED
#define MONSTERONMAPUPDATERESPONSEMESSAGE_HPP_INCLUDED
...
namespace Enigma
{
    class DllExport MonsterOnMapUpdateResponseMessage : public MessageContainer
    {
        private:
        ...
        MonsterOnMapUpdateResponseMessage(Message& message)
            :MessageContainer(message){};

        MonsterOnMapUpdateResponseMessage();
        ~MonsterOnMapUpdateResponseMessage();

        static const int GetMessageType(){return 35;}
...
#endif // MONSTERONMAPUPDATERESPONSEMESSAGE_HPP_INCLUDED
