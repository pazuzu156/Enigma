...
#include "CharacterCreationResponseMessage.hpp"
...
namespace Enigma
{
    ...
    {
        size_t size;
        size = CharacterCreationResponseMessage::GetMessageLength();
        this->ResizeMessage(size,0);
        this->SetType(CharacterCreationResponseMessage::GetMessageType());
