...
namespace Enigma
{
    ...
    PlayerOnMapUpdateRequestMessage::PlayerOnMapUpdateRequestMessage()
    {
        size_t size;
        size = PlayerOnMapUpdateRequestMessage::GetMessageLength();
        this->ResizeMessage(size,0);
        this->SetType(PlayerOnMapUpdateRequestMessage::GetMessageType());
