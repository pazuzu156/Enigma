#ifndef ITEMONMAPUPDATERESPONSEMESSAGE_HPP_INCLUDED
#define ITEMONMAPUPDATERESPONSEMESSAGE_HPP_INCLUDED
...
namespace Enigma
{
    class DllExport ItemOnMapUpdateResponseMessage : public MessageContainer
    {
        private:
        ...
        ItemOnMapUpdateResponseMessage(Message& message)
            :MessageContainer(message){};

        ItemOnMapUpdateResponseMessage();
        ~ItemOnMapUpdateResponseMessage();

        static const int GetMessageType(){return 37;}
