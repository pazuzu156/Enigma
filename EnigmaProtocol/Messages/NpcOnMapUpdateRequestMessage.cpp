...
namespace Enigma
{
    ...
    NpcOnMapUpdateRequestMessage::NpcOnMapUpdateRequestMessage()
    {
        size_t size;
        size = NpcOnMapUpdateRequestMessage::GetMessageLength();
        this->ResizeMessage(size,0);
        this->SetType(NpcOnMapUpdateRequestMessage::GetMessageType());
