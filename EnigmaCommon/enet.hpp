#ifndef ENET_HPP_INCLUDED
#define ENET_HPP_INCLUDED
...
*/
    ...
    #include <enet/enet.h>
    #pragma warning( pop )
    #define ENET_LOADED 1
#endif

#ifdef ENIGMA_PLATFORM_LINUX
    #include <enet/enet.h>
    #define ENET_LOADED 2
#endif

#ifdef ENIGMA_PLATFORM_MAC
    #include <enet/enet.h>
    #define ENET_LOADED 3
#endif

#ifdef ENIGMA_PLATFORM_BSD
    #include <enet/enet.h>
    #define ENET_LOADED 4
#endif

#ifdef ENIGMA_PLATFORM_OPENSOLARIS
    #include <enet/enet.h>
    #define ENET_LOADED 5
#endif

#ifndef ENET_LOADED
    #include <enet/enet.h>
    #define ENET_LOADED 6
#endif

#endif // ENET_HPP_INCLUDED
