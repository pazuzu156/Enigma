...
*/
    ...
    #include <alc.h>
    #pragma warning( pop )
    #define OPENAL_LOADED 1
#endif

#ifdef ENIGMA_PLATFORM_LINUX
    #include <AL/al.h>
    #include <AL/alc.h>
    #define OPENAL_LOADED 2
#endif

#ifdef ENIGMA_PLATFORM_MAC
    #include <al.h>
    #include <alc.h>
    #define OPENAL_LOADED 3
#endif

#ifdef ENIGMA_PLATFORM_BSD
    #include <AL/al.h>
    #include <AL/alc.h>
    #define OPENAL_LOADED 4
#endif

#ifdef ENIGMA_PLATFORM_OPENSOLARIS
    #include <AL/al.h>
    #include <AL/alc.h>
    #define OPENAL_LOADED 5
#endif

#ifndef OPENAL_LOADED
    #include <AL/al.h>
    #include <AL/alc.h>
    #define OPENAL_LOADED 6
#endif

#endif // OPENAL_HPP_INCLUDED
