...
namespace Enigma
{
    ...
    MonsterOnMapUpdateRequestMessage::MonsterOnMapUpdateRequestMessage()
    {
        size_t size;
        size = MonsterOnMapUpdateRequestMessage::GetMessageLength();
        this->ResizeMessage(size,0);
        this->SetType(MonsterOnMapUpdateRequestMessage::GetMessageType());
