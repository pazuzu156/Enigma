...
namespace Enigma
{
    ...
    {
        this->ResizeMessage(PlayerListRequestMessage::GetMessageLength(),0);
        this->SetType(PlayerListRequestMessage::GetMessageType());
    ...
    Enigma::s32 PlayerListRequestMessage::GetPlayerListType()
    {
        return this->GetInt(0);
    }

    void PlayerListRequestMessage::SetPlayerListType(Enigma::s32 value)
    {
        this->SetInt(0,value);
    }
